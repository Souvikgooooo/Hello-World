            ...
            <div className="voiceBody wholeeditorBody">
                ...
                <mark><h1>Image to Text Converter</h1></mark><br/>
                  <main className='imageMain'>
                    ...
                    <input type="submit" className='btn imgbtn' onClick={handleClick} value={isLoading? "Loading,Pls Wait...":"Convert To Text"} />
                    <button className='btn btnbtn' onClick={clear}>Clear</button>
                    </div>
                    
                    <div className="image-text-box">
                      {/* <p contentEditable>{text}</p> */}
                      <textarea name="vtext" id="vtext" placeholder='Enter Your Text Here' value={text} onChange={(e)=>{setText(e.target.value)}}></textarea>
                    </div>
                  </main>
                </div>
            </div>
