...
import Login_svg from '../../assets/back-to-work.svg';
    ...
    <div className="smallScreen">
      ...
      <div className="loginContainer">
        ...
        <div className="registerSVG loginimage">
                    ...
                    <p>Don't have an Account? <NavLink to="/register"><span className='registerSwitch'>Create a new one </span></NavLink></p>
        </div>
