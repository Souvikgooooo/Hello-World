        ...
        <img src={blob} alt="" className='blob_a blob3' />
            ...
            <div className='feedSection'>
                <div className='feedinfo'>
                    <p className="info">Let's Become a part of a amazing community <mark>Hello World</mark>. Tell your's <mark>Issue and suggestions Related to Website for Improving the Site Through Updation</mark></p>
                </div>
                <div className='feedform'>
                    <form>
                        ...
                        <div className="formbutton formDetails">
                            <button type='submit' onClick={submitData} className="btn formbtn">Send to Developer Team</button>
                        </div>
                    </form>
                </div>
            </div>
